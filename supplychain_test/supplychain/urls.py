...
from .views.pdf_views import RecordCsvExportView, RecordPdfExportView, VisibleTablePdfExportView
...
urlpatterns = [
    ...
    path("exports/<slug:kind>/<int:pk>.csv", RecordCsvExportView.as_view(), name="record-csv-export"),
